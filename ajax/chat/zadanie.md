...
Vytvorte chatovaciu aplikáciu, ktorá budem mať nasledujúce funkcie:
...
1. Vytvorte samostatného klienta, ktorý bude komunikovať so serverom pomocou API rozhrania asynchrónne.
