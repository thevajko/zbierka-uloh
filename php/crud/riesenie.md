...
Na začiatku si vytvoríme prázdnu entitu `User`. Ak máme k dispozícii parameter `id` tak prepíšeme túto entitu entitou z databázy. Ak nám `UserStorage::get()` vráti null, vypíšeme chybovú hlášku.
